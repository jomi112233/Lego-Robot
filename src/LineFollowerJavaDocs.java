 ...
 * starts Motors and calculator
 */
public class LineFollowerJavaDocs{
...
/**
 * calculates Motor Speeds according to reading from lightsensor and ultra sonic sensor
 * 
 * uses PID controller for following Line and step by step for obstacle avoidance
 */
...
class calculator implements Runnable{
    ...
    /**
     * main loop for switching between driving and avoiding
     */
    public void run(){
    ...
    /**
     * performs obstacle avoidance step by step
     * @param distance current distance from measured from the ultrasonic sensor
     */
    ...
    /**
     * Drives the robot based on the light sensor reading using a PID
...
/**
 * Reads data from Light sensor and checks if the robot is on the line
 */
class LightSensor implements Runnable {
    ...
    /**
     * returns the most recent light reading
     * @return light
     */
    ...
    /**
     * checks if the sensor is turneed on and is returning data
     * @return ready
     */
    public boolean isReady() {
        return ready;
    ...
    /**
     * gets the midpoint value between line and background
     * @return target light value
     */
    ...
    /**
     * 
     * @return true if the robot is on the line
     */
    public boolean onLine(){
        return onLine;
    }
    /**
     * Main loop for light sensor
     */
    public void run() {
    ...
    /**
     * calibrates the light sensor for better line folllowing performance
     * @param provider the current light reading
     * @param sample saves current light reading
     */
